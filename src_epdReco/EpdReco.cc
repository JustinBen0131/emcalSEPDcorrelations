...
int EpdReco::process_event(PHCompositeNode *topNode)
{
  ...
  TowerInfoContainer *_sepd_towerinfo = findNode::getClass<TowerInfoContainer>(topNode, "TOWERINFO_CALIB_SEPD");
...
void EpdReco::CreateNodes(PHCompositeNode *topNode)
{
  ...
  {
    m_TowerInfoContainer_calib = new TowerInfoContainerv4(TowerInfoContainer::DETECTOR::SEPD);
