...
#define R__DICTIONARY_FILENAME dIUsersdIpatsfan753dIDesktopdIauauAnalysisdIemcalSEPDcorrelationsdImacrosdIdOaclic_builddIanalyzeRun24or25auau_cpp_ACLiC_dict
   ...
   namespace ROOTDict {
      ...
      inline ::ROOT::TGenericClassInfo *GenerateInitInstance()
      {
         static ::ROOT::TGenericClassInfo 
            instance("term", 0 /*version*/, "analyzeRun24or25auau.cpp", 150,
...
namespace log {
   namespace ROOTDict {
      ...
      {
         static ::ROOT::TGenericClassInfo 
            instance("log", 0 /*version*/, "analyzeRun24or25auau.cpp", 159,
                     ::ROOT::Internal::DefineBehavior((void*)nullptr,(void*)nullptr),
                     &log_Dictionary, 0);
         return &instance;
      }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CutKey*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CutKey", "analyzeRun24or25auau.cpp", 253,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::NSCache<MapPair>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("NSCache<MapPair>", "analyzeRun24or25auau.cpp", 294,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::NSCache<MapPair>::H*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("NSCache<MapPair>::H", "analyzeRun24or25auau.cpp", 299,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::MapPair*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("MapPair", "analyzeRun24or25auau.cpp", 307,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::QA*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("QA", "analyzeRun24or25auau.cpp", 314,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Pi0QA*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Pi0QA", "analyzeRun24or25auau.cpp", 332,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Pi0QA::FitInfo*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Pi0QA::FitInfo", "analyzeRun24or25auau.cpp", 348,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Pi0QA::FitPair*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Pi0QA::FitPair", "analyzeRun24or25auau.cpp", 353,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::NSPair*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("NSPair", "analyzeRun24or25auau.cpp", 2114,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CorrQA*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CorrQA", "analyzeRun24or25auau.cpp", 2117,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::EmcalQA*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("EmcalQA", "analyzeRun24or25auau.cpp", 3008,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HcalQA*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HcalQA", "analyzeRun24or25auau.cpp", 3283,
...
namespace ROOT {
   static TClass *sEPDotherQA_Dictionary();
   static void sEPDotherQA_TClassManip(TClass*);
   static void delete_sEPDotherQA(void *p);
   static void deleteArray_sEPDotherQA(void *p);
   static void destruct_sEPDotherQA(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::sEPDotherQA*)
   {
      ::sEPDotherQA *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::sEPDotherQA));
      static ::ROOT::TGenericClassInfo 
         instance("sEPDotherQA", "analyzeRun24or25auau.cpp", 3629,
                  typeid(::sEPDotherQA), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &sEPDotherQA_Dictionary, isa_proxy, 4,
                  sizeof(::sEPDotherQA) );
      instance.SetDelete(&delete_sEPDotherQA);
      instance.SetDeleteArray(&deleteArray_sEPDotherQA);
      instance.SetDestructor(&destruct_sEPDotherQA);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::sEPDotherQA*)
   {
      return GenerateInitInstanceLocal(static_cast<::sEPDotherQA*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::sEPDotherQA*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *sEPDotherQA_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal(static_cast<const ::sEPDotherQA*>(nullptr))->GetClass();
      sEPDotherQA_TClassManip(theClass);
   return theClass;
   }

   static void sEPDotherQA_TClassManip(TClass* theClass){
      theClass->CreateAttributeMap();
      TDictAttributeMap* attrMap( theClass->GetAttributeMap() );
      attrMap->AddProperty("file_name","/Users/patsfan753/Desktop/auauAnalysis/emcalSEPDcorrelations/macros/./analyzeRun24or25auau.cpp");
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::NSDetectorQA<MBDTag>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("NSDetectorQA<MBDTag>", "analyzeRun24or25auau.cpp", 3811,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::NSDetectorQA<sEPDTag>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("NSDetectorQA<sEPDTag>", "analyzeRun24or25auau.cpp", 3811,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::MBDTag*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("MBDTag", "analyzeRun24or25auau.cpp", 4220,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::sEPDTag*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("sEPDTag", "analyzeRun24or25auau.cpp", 4236,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::EventQA*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("EventQA", "analyzeRun24or25auau.cpp", 4261,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::EventQA::VzPoint*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("EventQA::VzPoint", "analyzeRun24or25auau.cpp", 4716,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::JetQA*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("JetQA", "analyzeRun24or25auau.cpp", 4741,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::VnPlotQA*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("VnPlotQA", "analyzeRun24or25auau.cpp", 5425,
...
namespace ROOT {
   static TClass *TriggerQA_Dictionary();
   static void TriggerQA_TClassManip(TClass*);
   static void delete_TriggerQA(void *p);
   static void deleteArray_TriggerQA(void *p);
   static void destruct_TriggerQA(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TriggerQA*)
   {
      ::TriggerQA *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::TriggerQA));
      static ::ROOT::TGenericClassInfo 
         instance("TriggerQA", "analyzeRun24or25auau.cpp", 6105,
                  typeid(::TriggerQA), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &TriggerQA_Dictionary, isa_proxy, 4,
                  sizeof(::TriggerQA) );
      instance.SetDelete(&delete_TriggerQA);
      instance.SetDeleteArray(&deleteArray_TriggerQA);
      instance.SetDestructor(&destruct_TriggerQA);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TriggerQA*)
   {
      return GenerateInitInstanceLocal(static_cast<::TriggerQA*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::TriggerQA*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *TriggerQA_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal(static_cast<const ::TriggerQA*>(nullptr))->GetClass();
      TriggerQA_TClassManip(theClass);
   return theClass;
   }

   static void TriggerQA_TClassManip(TClass* theClass){
      theClass->CreateAttributeMap();
      TDictAttributeMap* attrMap( theClass->GetAttributeMap() );
      attrMap->AddProperty("file_name","/Users/patsfan753/Desktop/auauAnalysis/emcalSEPDcorrelations/macros/./analyzeRun24or25auau.cpp");
   }
...
namespace ROOT {
   // Wrapper around operator delete
   static void delete_sEPDotherQA(void *p) {
      delete (static_cast<::sEPDotherQA*>(p));
   }
   static void deleteArray_sEPDotherQA(void *p) {
      delete [] (static_cast<::sEPDotherQA*>(p));
   }
   static void destruct_sEPDotherQA(void *p) {
      typedef ::sEPDotherQA current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::sEPDotherQA
...
namespace ROOT {
   // Wrapper around operator delete
   static void delete_TriggerQA(void *p) {
      delete (static_cast<::TriggerQA*>(p));
   }
   static void deleteArray_TriggerQA(void *p) {
      delete [] (static_cast<::TriggerQA*>(p));
   }
   static void destruct_TriggerQA(void *p) {
      typedef ::TriggerQA current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::TriggerQA
...
namespace ROOT {
   static TClass *unordered_maplEstringcOshared_ptrlETH2gRsPgR_Dictionary();
   static void unordered_maplEstringcOshared_ptrlETH2gRsPgR_TClassManip(TClass*);
   static void *new_unordered_maplEstringcOshared_ptrlETH2gRsPgR(void *p = nullptr);
   static void *newArray_unordered_maplEstringcOshared_ptrlETH2gRsPgR(Long_t size, void *p);
   static void delete_unordered_maplEstringcOshared_ptrlETH2gRsPgR(void *p);
   static void deleteArray_unordered_maplEstringcOshared_ptrlETH2gRsPgR(void *p);
   static void destruct_unordered_maplEstringcOshared_ptrlETH2gRsPgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const unordered_map<string,shared_ptr<TH2> >*)
   {
      unordered_map<string,shared_ptr<TH2> > *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(unordered_map<string,shared_ptr<TH2> >));
      static ::ROOT::TGenericClassInfo 
         instance("unordered_map<string,shared_ptr<TH2> >", -2, "unordered_map", 1029,
                  typeid(unordered_map<string,shared_ptr<TH2> >), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &unordered_maplEstringcOshared_ptrlETH2gRsPgR_Dictionary, isa_proxy, 0,
                  sizeof(unordered_map<string,shared_ptr<TH2> >) );
      instance.SetNew(&new_unordered_maplEstringcOshared_ptrlETH2gRsPgR);
      instance.SetNewArray(&newArray_unordered_maplEstringcOshared_ptrlETH2gRsPgR);
      instance.SetDelete(&delete_unordered_maplEstringcOshared_ptrlETH2gRsPgR);
      instance.SetDeleteArray(&deleteArray_unordered_maplEstringcOshared_ptrlETH2gRsPgR);
      instance.SetDestructor(&destruct_unordered_maplEstringcOshared_ptrlETH2gRsPgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::MapInsert< unordered_map<string,shared_ptr<TH2> > >()));

      instance.AdoptAlternate(::ROOT::AddClassAlternate("unordered_map<string,shared_ptr<TH2> >","std::__1::unordered_map<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, std::__1::shared_ptr<TH2>, std::__1::hash<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>, std::__1::equal_to<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>, std::__1::allocator<std::__1::pair<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> const, std::__1::shared_ptr<TH2>>>>"));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const unordered_map<string,shared_ptr<TH2> >*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *unordered_maplEstringcOshared_ptrlETH2gRsPgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal(static_cast<const unordered_map<string,shared_ptr<TH2> >*>(nullptr))->GetClass();
      unordered_maplEstringcOshared_ptrlETH2gRsPgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_unordered_maplEstringcOshared_ptrlETH2gRsPgR(void *p) {
      return  p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) unordered_map<string,shared_ptr<TH2> > : new unordered_map<string,shared_ptr<TH2> >;
   }
   static void *newArray_unordered_maplEstringcOshared_ptrlETH2gRsPgR(Long_t nElements, void *p) {
      return p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) unordered_map<string,shared_ptr<TH2> >[nElements] : new unordered_map<string,shared_ptr<TH2> >[nElements];
   }
   // Wrapper around operator delete
   static void delete_unordered_maplEstringcOshared_ptrlETH2gRsPgR(void *p) {
      delete (static_cast<unordered_map<string,shared_ptr<TH2> >*>(p));
   }
   static void deleteArray_unordered_maplEstringcOshared_ptrlETH2gRsPgR(void *p) {
      delete [] (static_cast<unordered_map<string,shared_ptr<TH2> >*>(p));
   }
   static void destruct_unordered_maplEstringcOshared_ptrlETH2gRsPgR(void *p) {
      typedef unordered_map<string,shared_ptr<TH2> > current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class unordered_map<string,shared_ptr<TH2> >
...
class __attribute__((annotate("$clingAutoload$./analyzeRun24or25auau.cpp")))  sEPDotherQA;
...
class __attribute__((annotate("$clingAutoload$./analyzeRun24or25auau.cpp")))  TriggerQA;
...
"HcalQA", payloadCode, "@",
"HcalQA::s_missing", payloadCode, "@",
"HcalQA::s_runIDs", payloadCode, "@",
"HcalQA::s_scanned", payloadCode, "@",
"JetQA", payloadCode, "@",
"JetQA::Lvl", payloadCode, "@",
"MBDTag", payloadCode, "@",
...
"NSPair", payloadCode, "@",
"Pi0QA", payloadCode, "@",
"Pi0QA::Lvl", payloadCode, "@",
"Pi0QA::s_runPoints", payloadCode, "@",
"Pi0QA::s_summaryWritten", payloadCode, "@",
"QA", payloadCode, "@",
"SepdQA", payloadCode, "@",
"TriggerQA", payloadCode, "@",
"TriggerQA::Lvl", payloadCode, "@",
"TriggerQA::_emitted", payloadCode, "@",
"TriggerQA::_spectra", payloadCode, "@",
"TriggerQA::_spectraScaled", payloadCode, "@",
"VnPlotQA", payloadCode, "@",
"VnPlotQA::Lvl", payloadCode, "@",
"analyzeRun24or25auau", payloadCode, "@",
"binAt", payloadCode, "@",
"cPath", payloadCode, "@",
"decodeInvName", payloadCode, "@",
"discoverInputRuns", payloadCode, "@",
...
"mergeRunsAndReprocess", payloadCode, "@",
"prettifyTrigger", payloadCode, "@",
"processRunsSequentially", payloadCode, "@",
"runOneQaPass", payloadCode, "@",
"sEPDTag", payloadCode, "@",
"sEPDTag::subdir", payloadCode, "@",
"sEPDTag::titleNorth", payloadCode, "@",
"sEPDTag::titleSouth", payloadCode, "@",
"sEPDotherQA", payloadCode, "@",
"save1D", payloadCode, "@",
"save2D", payloadCode, "@",
"sector_from_idx", payloadCode, "@",
"selectTopNRuns", payloadCode, "@",
